                    ...
                    {people.map((person) => (
                        <li key={person.email} className="col-span-1 bg-white rounded-lg shadow-md divide-y divide-gray-200">
                            <div className="w-full p-6">
                                <img className="w-28 h-28 mx-auto bg-gray-300 rounded-full flex-shrink-0" src={person.imageUrl} alt="" />
                                <div className="my-5">
                                    <h3 className="text-gray-900 text-lg font-medium text-center">Syed Rezwanul Haque.</h3>
                                    <p className="mt-1 text-gray-500 text-sm text-center">Managing Director, Technext Limited Alumni, Computer Science
                                        & Engineering, Shahjalal University of Science & TechnologyD</p>
                                </div>
                                <div className="my-5 flex">
                                    <h1 className="mr-4 text-sm flex py-1">Button-1 : </h1>
                                    <button className="py-1 px-4 border rounded-lg text-sm ">http://souravkairy.me</button>
                                </div>
                                <div className="my-5 flex">
                                    <h1 className="mr-4 text-sm flex py-1">Button-1 : </h1>
                                    <button className="py-1 px-4 border rounded-lg text-sm ">http://souravkairy.me</button>
