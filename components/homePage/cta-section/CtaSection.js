                ...
                <div className="bg-indigo-700 rounded-lg overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
                    <div className="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
                        <div className="lg:self-center">
                            <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
                                <span className="block">A father enjoying the remarkable
                                    childhood of his son.</span>
                            </h2>
                            <p className="mt-4 text-base leading-6 text-indigo-200">
                                A father enjoying the remarkable
                                childhood of his son.
                            </p>
                            <a
                                href="#"
                    ...
                    <div className="-mt-6 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1">
                        <img
                            ...
                            src="https://rezahaque.me/assets/img/family3.jpg"
                            alt="App screenshot"
                        />
                    </div>
                </div>
