...
const SvgInstagramSquareBrands = (props) => (
  <svg
    aria-hidden="true"
    data-prefix="fab"
    data-icon="instagram-square"
    className="instagram-square-brands_svg__svg-inline--fa instagram-square-brands_svg__fa-instagram-square instagram-square-brands_svg__fa-w-14"
...
export default SvgInstagramSquareBrands;
