...
const SvgInboxInSolid = (props) => (
  <svg
    aria-hidden="true"
    data-prefix="fas"
    data-icon="inbox-in"
    className="inbox-in-solid_svg__svg-inline--fa inbox-in-solid_svg__fa-inbox-in inbox-in-solid_svg__fa-w-18"
