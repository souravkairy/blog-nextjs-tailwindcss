...
const SvgYoutubeSquareBrands = (props) => (
  <svg
    aria-hidden="true"
    data-prefix="fab"
    data-icon="youtube-square"
    className="youtube-square-brands_svg__svg-inline--fa youtube-square-brands_svg__fa-youtube-square youtube-square-brands_svg__fa-w-14"
...
export default SvgYoutubeSquareBrands;
